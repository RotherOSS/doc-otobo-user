...
Shared Secret
   ...
   It must contain only uppercase letters (A-Z) and numbers (2-7).
   Click on the *Generate* button to generate a secret.
...
To see all available languages, click on the refresh icon next to the drop-down list.
